...
contoh: greetings("Yusni");
Output: "Halo Yusni, Selamat Datang di The Bookwormies!"
*/
...
reverseString("Elva Yudista");
reverseString("The Bookwormies");
reverseString("We Are The Wormies");
